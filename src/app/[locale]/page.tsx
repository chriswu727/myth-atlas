        ...
        <div className="atlas-intro">
          <div>
            ...
            <h2 className="atlas-title mt-3">
              {locale === "zh" ? "循星迹，渡向诸神故土" : "Follow the star-paths to the homelands of gods"}
            </h2>
          </div>
          <div className="atlas-deck">
            <p className="mt-5 text-vellum-dim">
              {locale === "zh"
                ? "每一枚星标，都是一方古老神域的门扉。俯近大地，神迹、异兽与夜行怪谈便从沉睡的坐标中浮现。"
                : "Each star is a gate into an elder mythology. Draw close to the earth and the sites of miracles, monsters, and night-born tales rise from sleeping coordinates."}
            </p>
